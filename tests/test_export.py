...
class ExportTests(unittest.TestCase):
    ...
    def test_svg_titles_can_include_group_metadata(self) -> None:
        """Render SVG titles with both label and group lines."""
        generator = DendrogramGenerator()
        directory, input_path = write_deep_branch_tree_csv()
        output_svg = directory / "titles-with-group.svg"
