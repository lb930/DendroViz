...
class LoadTreeCsvTests(unittest.TestCase):
    """Tests specifically for CSV-formatted tree data."""
...
class LoadTreeJsonTests(unittest.TestCase):
    """Tests specifically for JSON-formatted tree data."""
...
class LoadTreeNewickTests(unittest.TestCase):
    """Tests specifically for Newick-formatted tree data and its dependencies."""
